...
def get_segments(
    ...
    lang: str = None, # lang mandatory for multilingual models
...
def _prepare_tokenized_text_for_bpe_model(text: List[str], tokenizer, vocabulary: List[str], blank_idx: int = 0, lang: str = None):
    """ Creates a transition matrix for BPE-based models"""
    """ Marvin: lang is mandatory for multilingual models """
    ...
    for uttr in text:
        ...
        if lang is not None:
            token_ids = tokenizer.text_to_ids(uttr, lang)
        else:
